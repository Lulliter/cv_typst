...
- Prepared intensive courses on Statistics and Machine Learning with R
]
...
#resume-item[
- Advised on monitoring of PNRR (EU funds for regional cohesion) advancement
- Built automated reports to track funded projects and their outputs
]
...
#resume-item[
- Advised the Infrastructure Working Group (IWG) during Italy's G20 Presidency in 2021
- Coordinated 3 junior resources and the infrastructure resilience and maintenance workstream
]
...
- Contributed to preparation of technical and financial proposal to the European Parliament's Committee on Regional Development (REGI)
]
...
- Supervised a consulting team that conducted field surveys in Brazil and Mexico
]
...
- Conducted feasibility and impact evaluation studies focused on infrastructure poverty dimensions in rural and urban areas of Mumbai (India), Nairobi (Kenya), Kampala (Uganda), and Dhaka (Bangladesh)
]
...
#resume-item[
- Assisted in social development project on education and vocational training in Fortaleza, Brazil
- Presented comparative policy paper on entrepreneurship promotion to Division
]
...
- Advised on data sharing among AVSI inter-city educational interventions in urban 'favelas'
]
...
#resume-item[
- Provided business intelligence for several Italian clients and their domestic and international operations
- Participated in due diligences and competitive positioning analyses to assist private equity investors in a industrial operations
]
#pagebreak()
= Education
<education>
...
#resume-entry(title: "Potenziali priorita' per la Presidenza Italiana G20 nell'area tematica Infrastrutture",location: "Roma",date: "May-2020",description: "Seminario interno MEF",)
...
#resume-entry(title: "The Regulation of Public Utilities of the Future in Latin America and the Caribbean - Water and Sewerage Sector",location: "Washington, D.C.",date: "Sep-2018",description: "Red De Centros 1st Seminar",)
#resume-entry(title: "Integrating Multi-Dimensional Data for Inclusive and Sustainable Development of Urban Slums - Preliminary Findings from Dhaka Pilot (Phase I)",location: "Washington, D.C.",date: "Sep-2017",description: "World Bank Staff Seminar",)
= Illustrative Data Science Projects
<illustrative-data-science-projects>
#resume-entry(title: "Intensive 4-day summer doctoral level workshop organized by MITGEST",location: "Nijmegen, Netherland",date: "2024",description: "Lectures and technical lab materials for a 4-day intensive summer program in biostatistics",)
#resume-item[
- [Introductory workshop on Biostatistics with R](https://r4biostats.com/)
]
#resume-entry(title: "NLP study applied to policy making",location: "online",date: "2022 - Present",description: "(Ongoing) What is the influence of slogans on policy making?",)
#resume-item[
- [Study of computational linguistic applied to policy](https://lulliter.github.io/slogan/)
]
#resume-entry(title: "Programming tutorials",location: "online",date: "2024 - Present",description: "Collection of tutorials and experiments on programming languages and tools (R, git, AWS, VSCOde, etc.)",)
#resume-item[
- [Miscellaneous programming notes](https://lulliter.github.io/nerd_help/)
]
