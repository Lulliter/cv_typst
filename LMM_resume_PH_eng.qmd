...
#align(center)[
  ...
  #set text(
    ...
    Economist with 20 years of international experience in development economics and quantitative policy analysis. Currently based in Italy, working as a freelance consultant for public and private entities, research institutes, and nonprofits. I help with data collection, analysis, modelling and visualization.\ 
    I also offer training on applied statistics, machine learning and reproducible research.
]
```
