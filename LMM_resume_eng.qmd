...
skill |>
	...
	mutate(area = case_when(
		area %in% c("Programming Languages", "Misc. Dev. Tools") ~ "Programming & Misc. Dev. Tools",
		TRUE ~ area
	)) |> 
	mutate(area = factor(area, levels = unique(area))) |>  # Preserve original order
	group_by(area) |> 
...
See my website for data science projects, ![](assets/icon/r-project-brands-solid.svg){height=1em} code, writing, and teaching resources: [**www.luisamimmi.org**](https://luisamimmi.org/)
:::
