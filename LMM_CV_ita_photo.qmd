...
author:
  ...
  position: "Economista | Analista di politiche pubbliche | Consulente con P.IVA" #   "Data Science | Analisi di politiche pubbliche | Consulenza freelance" # 
  contacts:
    - icon: fa envelope
...
Economista con esperienza internazionale nella valutazione di politiche economiche. Ho vissuto 14 anni a Washington, DC, lavorando per organizzazioni internazionali su monitoraggio e valutazione di progetti di sviluppo sostenibile. Dal rientro in Italia, nel 2020, sono consulente per enti pubblici e privati, istituti di ricerca e nonprofit (analisi quantitative, rendicontazione e gestione di fondi UE/PNRR, _grant proposal_). #linebreak()
Ho al mio attivo varie pubblicazioni e corsi di formazione su applicazioni di statistica e machine learning. #linebreak()
Mi appassiona la ricerca empirica e l’uso dei dati per orientare in modo _evidence-based_ le politiche pubbliche. Coltivo un forte interesse per i linguaggi di programmazione e le tecniche per l’analisi riproducibile dei dati.
