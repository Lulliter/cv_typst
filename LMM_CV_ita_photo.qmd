...
author:
  ...
  position: "Economista | Data Analyst | Consulente indipendente" #   "Data Science | Analisi di politiche pubbliche | Consulenza freelance" # 
  contacts:
    - icon: fa envelope
...
Economista con esperienza internazionale nella valutazione di politiche economiche. Ho vissuto 14 anni a Washington, DC, lavorando come *M&E Specialist* per organizzazioni internazionali su monitoraggio e valutazione di programmi di sviluppo. Dal rientro in Italia, nel 2020, sono consulente per enti pubblici e privati, istituti di ricerca e nonprofit (analisi quantitative, rendicontazione e gestione di fondi UE/PNRR, _grant proposal_). Ho al mio attivo varie pubblicazioni e corsi di formazione su applicazioni di statistica e *machine learning*.  
Mi appassiona la ricerca empirica e l’uso dei dati per orientare in modo _evidence-based_ le politiche pubbliche e mi piace studiare linguaggi di programmazione e tecniche per l'analisi riproducibile dei dati. 
...
### [2020–Oggi] Consulente (con Partita IVA) in data science e analisi di politiche pubbliche
...
Sul mio [**profilo Google Scholar**](https://scholar.google.com/citations?user=OBYla5gAAAAJ&hl=en&oi=ao) sono riportate le mie pubblicazioni (tra cui 4 su riviste con revisione paritaria).
...
Sul mio sito ([**www.luisamimmi.org/projects/**](https://luisamimmi.org/projects/)) si trovano alcuni progetti tra cui: corsi presentati, codice scritto per l'esplorazione, modellazione e visualizzazione di dati, o analisi su diversi temi di carattere socio-economico.
