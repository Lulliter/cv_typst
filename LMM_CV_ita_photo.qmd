...
author:
  ...
  position: "Economista | Business Analyst | Consulente freelance" #   "Data Science | Analisi di politiche pubbliche | Consulenza freelance" # 
  contacts:
    - icon: fa envelope
...
Economista con esperienza internazionale nella valutazione di politiche economiche. Ho vissuto 14 anni a Washington, DC, lavorando come *M&E Specialist* per organizzazioni internazionali su monitoraggio e valutazione d'impatto di programmi di sviluppo. Dal rientro in Italia, nel 2020, sono consulente per enti pubblici, istituti di ricerca e nonprofit, con focus su analisi quantitativa, gestione di fondi UE/PNRR, ecc. Ho al mio attivo varie pubblicazioni e ho svolto corsi di formazione su applicazioni di statistica e *machine learning*.  
Mi appassiona la ricerca empirica e l’uso dei dati per orientare in modo _evidence-based_ le politiche pubbliche; per questo mi piace imparare linguaggi di programmazione e tecniche per l'analisi riproducibile dei dati. 

## Esperienza professionale

### [2020–Oggi] Consulente in data science e analisi di politiche pubbliche
...
### [2008–2019] Monitoring & Evaluation Specialist per programmi di sviluppo economico
...
Le mie pubblicazioni (tra cui alcune su riviste con revisione paritaria) sono accessibili sul mio [**profilo Google Scholar**](https://scholar.google.com/citations?user=OBYla5gAAAAJ&hl=en&oi=ao) 
...
Qui alcuni progetti di interesse personale, in cui ho utilizzato soprattutto il software **R** per l'esplorazione, modellazione e visualizzazione di dati, o per analisi socio-economiche: [**www.luisamimmi.org/projects/**](https://luisamimmi.org/projects/)
